...
import { events, formatEventDate, isUpcoming, type Event } from "@/data/events";
...
function EventsPage() {
  ...
  const list = events.filter((e) => (tab === "upcoming" ? isUpcoming(e.date) : !isUpcoming(e.date)));
      ...
      <div className="mt-10 columns-1 gap-4 sm:columns-2 lg:columns-3">
        <AnimatePresence initial={false} mode="popLayout">
          {list.map((e, i) => (
            ...
            >
              <div className={`overflow-hidden ${i % 3 === 1 ? "aspect-[4/5]" : "aspect-[16/10]"}`}>
                <img
                  src={e.cover}
                  alt={e.name}
                  loading="lazy"
